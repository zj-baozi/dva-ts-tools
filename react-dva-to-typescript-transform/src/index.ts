...
} from "./transforms/class-instance-variables-transform";
import {
...
import { collapseIntersectionInterfacesTransformFactoryFactory
...
} from "./transforms/react-stateless-function-make-props-transform";
import {
  reactRemovePropTypesImportTransformFactoryFactory
} from "./transforms/react-remove-prop-types-import";

import {
  dvaConnectTransformFactory
} from "./transforms/dva-connect-transform";
import {
  dvaModelTransformFactoryFactory
} from "./transforms/dva-model-transform";
